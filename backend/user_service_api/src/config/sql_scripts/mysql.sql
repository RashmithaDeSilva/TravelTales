...
INSERT INTO users (id, first_name, surname, email, email_verify, contact_number, password_hash)
SELECT 
    1, 'Tom', 'Smith', 'tom@example.com', false, '+94761234567', 
    '$argon2id$v=19$m=65536,t=3,p=1$4Z0ePixF6hbnfppLSoqlYw$5iLt1QIXlARhJc2mSwXB5yETHH+ZsKslfB03XJpntCg' -- password12345
WHERE NOT EXISTS (SELECT 1 FROM users WHERE id = 1);

INSERT INTO users (id, first_name, surname, email, email_verify, contact_number, password_hash)
SELECT 
    2, 'Alice', 'Johnson', 'alice@example.com', false, '+94761234568', 
    '$argon2id$v=19$m=65536,t=3,p=1$5X9nGtN35zEV7MNOBqaE3w$wTkOMIwi3H3gxsRU0eDd5IZl4OdyBdd88x2hFzG2FAY'
WHERE NOT EXISTS (SELECT 1 FROM users WHERE id = 2);

INSERT INTO users (id, first_name, surname, email, email_verify, contact_number, password_hash)
SELECT 
    3, 'Bob', 'Davis', 'bob@example.com', false, '+94761234569', 
